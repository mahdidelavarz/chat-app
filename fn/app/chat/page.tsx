...
//   if (loading) {
//     return (
//       <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0F1419] via-[#151E27] to-[#1A2332]">
...
//   return (
//     <div className="flex h-screen bg-gradient-to-br from-[#0F1419] via-[#151E27] to-[#1A2332] overflow-hidden">
//       {/* Mobile Menu Button */}
//       <button
...
//           transform transition-transform duration-300 ease-in-out z-50 h-screen
//           ${sidebarOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}
//         `}
//       >
//         {/* User Profile Header */}
//         <div className="p-5 border-b border-gray-700/50 bg-gradient-to-r from-[#1D2733] to-[#222E3C]">
//           <div className="flex justify-between items-center">
//             <div className="flex items-center gap-3">
//               <div className="relative">
//                 <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex justify-center items-center shadow-lg">
//                   <SolarUserRoundedBoldDuotone className="text-white w-6 h-6" />
//                 </div>
//                 <div className="absolute bottom-0 right-0 w-3.5 h-3.5 bg-green-500 rounded-full border-2 border-[#1D2733]"></div>
//               </div>
//               <div>
...
//               className="px-3 py-1.5 bg-red-500/20 text-red-400 rounded-lg hover:bg-red-500/30 transition-all text-xs font-semibold border border-red-500/30"
//             >
//               Logout
//             </button>
//           </div>
...
//               className="w-full px-4 py-2.5 pl-10 bg-[#222E3C] text-gray-200 text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 border border-gray-700/50"
//             />
//             <svg
...
//               }}
//               className={`p-4 cursor-pointer hover:bg-[#222E3C]/50 transition-all border-b border-gray-700/30 ${
...
//               <div className="flex items-center gap-3">
//                 <div className="relative">
//                   <div className="w-11 h-11 rounded-full bg-gradient-to-br from-blue-400 to-purple-500 flex justify-center items-center">
...
//                       <div className="w-3 h-3 bg-green-500 rounded-full border-2 border-[#1A2332]"></div>
...
//                     </p>
//                     {unreadCounts[u.id] > 0 && (
//                       <span className="ml-2 px-2 py-0.5 bg-blue-500 text-white text-xs font-bold rounded-full min-w-[20px] text-center">
//                         {unreadCounts[u.id]}
//                       </span>
//                     )}
//                   </div>
...
//           {/* Chat Header */}
//           <div className="bg-gradient-to-r from-[#1D2733] to-[#222E3C] p-4 border-b border-gray-700/50 shadow-xl backdrop-blur-xl">
//             <div className="flex items-center justify-between">
//               <div className="flex items-center gap-3">
//                 <div className="relative">
//                   <div className="w-11 h-11 rounded-full bg-gradient-to-br from-blue-400 to-purple-500 flex justify-center items-center">
...
//                     <div className="absolute bottom-0 right-0 w-3 h-3 bg-green-500 rounded-full border-2 border-[#222E3C]"></div>
//                   )}
//                 </div>
//                 <div>
//                   <h2 className="text-base font-semibold text-slate-100">
...
//                 >
//                   <div
//                     className={`max-w-[75%] px-4 py-2.5 rounded-2xl shadow-lg transition-all hover:shadow-xl ${
...
//           {/* Reply Preview */}
//           {replyingTo && (
//             <div className="px-4 py-2 bg-[#1D2733] border-t border-gray-700/50">
...
//           <div className="bg-gradient-to-r from-[#1D2733] to-[#222E3C] border-t border-gray-700/50 p-4">
...
//                   className="p-2.5 bg-[#222E3C] hover:bg-gray-700 rounded-xl transition-all border border-gray-700/50"
//                 >
//                   <svg
...
//                 className="flex-1 rounded-xl px-4 py-3 bg-[#222E3C] text-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 border border-gray-700/50 transition-all"
//               />
...
//                 className="p-2.5 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
//               >
//                 <SolarArrowDown width={24} className="text-white rotate-180" />
//               </button>
//             </form>
//           </div>
